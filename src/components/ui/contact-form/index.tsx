...
export const ContactForm = () => {
	return <section className="bg-[#F5F5F5] py-20 px-10">
		<div className="container flex items-center justify-center gap-[53px] max-[1200px]:flex-wrap py-20">
			<img src="/public/contact-phones.webp" alt="" />
			<div className='max-w-[500px] w-full'>
				...
				<form action="" className='flex flex-col gap-4 items-start'>
					...
					<Button text='Yuborish' icon='/public/icons/send.svg' />
				</form>
			</div>
		</div>
	</section>
